...
$lang['about_app_info'] = 'CaCaBoo je visoko prilagodljiva web aplikacija koja omogućuje vašim klijentima da rezerviraju sastanke s vama putem weba. Osim toga, omogućuje sinkronizaciju vaših podataka s Google kalendarom, tako da ih možete koristiti s drugim uslugama.';
$lang['current_version'] = 'Trenutačna verzija';
$lang['support'] = 'Podrška';
$lang['about_app_support'] = 'Ako naiđete na probleme prilikom korištenja CaCaBoo, možete pretraživati službenu Google grupu za odgovore. Možda ćete također trebati stvoriti novi problem na stranici Google Code kako biste pomogli napretku razvoja.';
...
$lang['about_app_license'] = 'CaCaBoo je licenciran pod GPLv3 licencom. Korištenjem koda CaCaBoo na bilo koji način pristajete na uvjete opisane na sljedećem URL-u:';
...
$lang['ea_update_success'] = 'CaCaBoo je uspješno ažuriran.';
...
$lang['api_token_hint'] = 'Postavite tajni token kako biste omogućili autentifikaciju temeljenu na tokenima za CaCaBoo API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API vam omogućuje interakciju sa svim podacima CaCaBoo putem HTTP protokola i dostupnih krajnjih točaka API-ja te stvaranje vlastitih integracija.';
...
$lang['connect'] = 'Poveži';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Ova integracija omogućuje vam povezivanje s postojećim LDAP poslužiteljem i automatsko uvođenje korisnika u CaCaBoo i omogućuje im SSO s njihovom lozinkom iz imenika (korisničko ime mora odgovarati).';
