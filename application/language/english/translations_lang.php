...
$lang['car_plate'] = 'Car Plate';
$lang['car_location'] = 'Car Location';
...
$lang['appointment_details_available_in_calendar'] = 'Appointment details are available in your personal account.';
...
$lang['about_app_info'] = 'CaCaBoo is a highly customizable web application that allows your customers to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using CaCaBoo you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'CaCaBoo is licensed under the GPLv3 license. By using the code of CaCaBoo in any way you are agreeing to the terms described in the following url:';
...
$lang['ea_update_success'] = 'CaCaBoo has been successfully updated.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the CaCaBoo API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API enable you to interact with all the CaCaBoo data via the HTTP protocol and the available API endpoints and create your own integrations.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'This integration enables you to connect to an existing LDAP server and automatically import users into CaCaBoo and let them SSO with their directory password (username must match).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
