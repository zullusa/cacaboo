...
$lang['support'] = 'תמיכה';
$lang['about_app_support'] = 'אם נתקלת בבעיות בעת השימוש ב-CaCaBoo, תוכל לחפש תשובות בקבוצת Google הרשמית. ייתכן שתצטרך גם ליצור דיווח חדש בדף Google Code כדי לסייע בתהליך הפיתוח.';
...
$lang['license'] = 'רישיון';
$lang['about_app_license'] = 'CaCaBoo מורשה תחת רישיון GPLv3. בשימוש בקוד של CaCaBoo בכל דרך שהיא, אתה מסכים לתנאים המתוארים בכתובת הבאה:';
...
$lang['ea_update_success'] = 'CaCaBoo עודכן בהצלחה!';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API מאפשרים לך אינטראקציה עם כל הנתונים של CaCaBoo דרך פרוטוקול HTTP וה-endpoints הזמינים וליצור אינטגרציות משלך.';
...
$lang['connect'] = 'התחבר';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'אינטגרציה זו מאפשרת לך להתחבר לשרת LDAP קיים ולייבא משתמשים באופן אוטומטי ל-CaCaBoo ולאפשר להם התחברות חד-פעמית עם סיסמת הספרייה שלהם (שם המשתמש חייב להתאים).';
$lang['host'] = 'שרת';
$lang['port'] = 'פורט';
