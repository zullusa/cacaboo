...
$lang['service_and_provider'] = 'Выберите услугу и исполнителя';
$lang['select_service'] = 'Выберите услугу';
$lang['select_provider'] = 'Выберите исполнителя';
...
$lang['notes'] = 'Заметки';
$lang['car_make'] = 'Марка автомобиля';
$lang['car_plate'] = 'Госрег номер';
$lang['car_location'] = 'Местонахождение авто';
$lang['car_location_owner'] = 'у владельца';
$lang['car_location_at_shop'] = 'у нас';
$lang['author'] = 'Автор';
$lang['language'] = 'Язык';
...
$lang['customer_details_title'] = 'Детали клиента';
$lang['service'] = 'Услуга';
$lang['provider'] = 'Исполнитель';
$lang['provider_name'] = 'Название исполнителя';
...
$lang['manage_appointment_record_hint'] = 'Управление назначениями которые доступны исполнителям и клиентам.';
$lang['select_filter_item_hint'] = 'Выберите исполнителя или услугу и просматривайте соответствующее назначения в календаре.';
$lang['enable_appointment_sync_hint'] = 'Включить синхронизацию назначений с Google-календарями исполнителей.';
$lang['manage_customers_hint'] = 'Управление зарегистрированными клиентами и просмотр их истории заказов.';
...
$lang['select'] = 'Выбрать';
$lang['hide'] = 'Скрыть';
$lang['type_to_filter_customers'] = 'Тип фильтрации клиентов.';
$lang['clear_fields_add_existing_customer_hint'] = 'Очистить поля и ввести нового клиента.';
$lang['pick_existing_customer_hint'] = 'Выберите существующего клиента.';
...
$lang['customer_saved'] = 'Клиент успешно сохранён.';
$lang['customer_deleted'] = 'Клиент успешно удалён.';
...
$lang['about_app'] = 'О приложении CaCaBoo';
...
$lang['book_advance_timeout_hint'] = 'Определить перерыв (в минутах) до того как клиент сделает заказ или переназначит назначение в компании.';
$lang['timeout_minutes'] = 'Время вышло (минут)';
$lang['about_app_info'] = 'CaCaBoo хорошо настраиваемое веб приложение которое позволяет вашим клиентам оформлять время предоставления услуг через интернет. Кроме того, имеется возможность синхронизации с вашими Google-календарями так что вы сможете использовать план заказанных мероприятий.';
$lang['current_version'] = 'Текущая версия';
$lang['support'] = 'Поддержка';
$lang['about_app_support'] = 'Если произошли проблемы с использованием CaCaBoo вы можете использовать официальную Google группу для поиска ответа. Вы можете также создать новый запрос на странице проекта в Google Code вопрос на странице Google Code для того, чтобы помочь проекту развиватся.';
...
$lang['about_app_license'] = 'CaCaBoo обладает лицензией GPLv3. При использовании кода приложения в любом случае вы соглашаетесь с условиями, описанными в следующей URL:';
...
$lang['delete_customer'] = 'Удалить клиента';
...
$lang['api_token_hint'] = 'Установите секретный токен, чтобы включить аутентификацию на основе токена в CaCaBoo API.';
$lang['timezone'] = 'Часовой пояс';
$lang['overwrite_existing_working_plans'] = 'Это перезапишет существующие рабочие планы исполнителя - Вы уверены что хотите продолжить?';
$lang['working_plans_got_updated'] = 'Все рабочие планы были обновлены.';
$lang['apply_to_all_providers'] = 'Применяется ко всем исполнителям услуг';
$lang['display_any_provider'] = 'Отображать параметры любого исполнителя';
$lang['display_any_provider_hint'] = 'На странице бронирования появится дополнительная опция, позволяющая клиентам бронировать без указания исполнителя услуг.';
...
$lang['phone_starts_with_8'] = 'Номер начинается с 8. Возможно, последняя цифра введена неправильно. Проверьте номер и нажмите OK для сохранения или Отмена для исправления.';
$lang['reminder_no_phone'] = 'У клиента не указан номер телефона (0). Напоминание не отправлено.';
...
$lang['limit_customer_access_hint'] = 'Если эта функция включена, исполнители и секретари смогут получить доступ только к тем клиентам, с которыми у них назначена встреча.';
$lang['url'] = 'URL';
...
$lang['provider_save'] = 'Сохранить исполнителя';
$lang['provider_delete'] = 'Удалить исполнителя';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API позволяют вам взаимодействовать со всеми данными CaCaBoo через протокол HTTP и доступные конечные точки API и создавать собственные интеграции.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Эта интеграция позволяет вам подключиться к существующему серверу LDAP и автоматически импортировать пользователей в CaCaBoo и предоставить им возможность входа через SSO с их паролем из каталога (имя пользователя должно совпадать).';
$lang['host'] = 'Хост';
$lang['port'] = 'Порт';
...
$lang['provider_has_conflicting_appointment'] = 'У выбранного исполнителя уже есть другая запись на это время. Пожалуйста, выберите другое время или исполнителя.';
...
$lang['no_available_service_providers_message'] = 'В настоящее время нет доступных услуг или исполнителей для бронирования. Пожалуйста, проверьте позже или свяжитесь с нами для получения помощи.';
...
$lang['notify'] = 'Оповестить';
$lang['reminder_sent'] = 'Оповещение отправлено';
$lang['reminder_not_available'] = 'Оповещение доступно только до начала записи и не ранее чем за сутки';
